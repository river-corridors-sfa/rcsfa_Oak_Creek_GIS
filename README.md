...
Each file type has a subfolder. Within each subfolder, you will find a readme that tells you the source of these files. If these files are used for a manuscript, the source will need to be cited in the data package.
